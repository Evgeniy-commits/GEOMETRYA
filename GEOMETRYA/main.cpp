...
//#define PERFECT_NUMBER_EYLER_CLASSWORK
...
#ifdef SQUARD
	int a;
	cout << "Введите длину стороны квадрата: "; cin >> a;
...
#ifdef TRIANGLE
	int a;
	cout << "Введите длину стороны треуголника: "; cin >> a;
	...
	/*Совершенные числа можно найти по формуле Эйлера : perfect_number = 2 ^ p - 1 * (2 ^ p - 1),
	где р - простое число, а второй множитель называется числом Мерсенна */
